...
| [School-JDBC](https://github.com/AndreaMoschella3/School-JDBC) | **Java connection to MySQL via JDBC, execution of queries (SELECT, INSERT, UPDATE, DELETE), and handling of connections and exceptions.**
 | Java + JDBC |
