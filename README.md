...
| [School-JDBC](https://github.com/AndreaMoschella3/School-JDBC) | Connessione Java a MySQL tramite JDBC, esecuzione di query (SELECT, INSERT, UPDATE, DELETE), gestione connessioni ed eccezioni | Java + JDBC |
